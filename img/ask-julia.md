...
<table style="border:2px solid red; border-collapse:collapse;">
  <tr>
    ...
    <td style="border:2px solid red; text-align:center; vertical-align:middle;"><img src="ask-julia_mobile.jpg" alt="six_hats_app_mobile" style="width:100%; border:2px solid red;"></td>
